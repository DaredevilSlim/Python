...
# информации x в ту, которую получит участник i+1 от участника i. Тогда последний n-й участник получит данные y, которые
# будут выражаться следующей формулой:
# y = Fn-1(Fn-2(…F2(F1(x))))
