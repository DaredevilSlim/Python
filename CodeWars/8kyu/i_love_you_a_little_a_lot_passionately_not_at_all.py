...
def how_much_i_love_you(nb_petals: int) -> str:
    result = nb_petals % 6
    nb_dict = {0: 'not at all', 1: 'I love you', 2: 'a little', 3: 'a lot', 4: 'passionately', 5: 'madly'}
    return nb_dict[result]


print(how_much_i_love_you(7))  # 'I love you'
print(how_much_i_love_you(3))  # 'a lot'
print(how_much_i_love_you(6))  # 'not at all'
print(how_much_i_love_you(478))  # 'passionately'
print(how_much_i_love_you(471))  # 'a lot'
