...
print('3.1. Математические операторы')
...
print('3.3. Операторы для работы с последовательностями')
...
print('3.4. Операторы присваивания')
...
print('3.6. Приоритет операторов')
...
# 1. '-х', '+х', '~х', '**' - унарный минус, унарный плюс, двоичная инверсия, возведение в степень. Если унарные
# операторы расположены слева от оператора '**', то возведение в степень имеет больший приоритет, а если справа - то
# меньший. Например, выражение:
# -10 ** -2
