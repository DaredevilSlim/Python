...
print('Инструкции ветвления, выбора и циклы')
...
# Оператор присваивания в составе инструкции:= полностью аналогичен оператору присваивания =, за тем исключением, что он
