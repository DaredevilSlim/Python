...
# Наконец, можно определять функции, принимающие произвольное количество параметров.
# Для этого в определении функции в составе набора принимаемых параметров следует ука­
# зать одну из следующих языковых конструкций или сразу обе:
#
#
#
#
