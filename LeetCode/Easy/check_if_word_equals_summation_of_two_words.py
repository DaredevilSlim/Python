...
def is_sum_equal(first_word: str, second_word: str, target_word: str) -> bool:
    ...
    first = int(''.join(str(alphabet.index(i)) for i in first_word))
    second = int(''.join(str(alphabet.index(i)) for i in second_word))
    target = int(''.join(str(alphabet.index(i)) for i in target_word))
