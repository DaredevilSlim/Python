...
print(vowel_strings(['are', 'amy', 'u'], 0, 2))  # 2
print(vowel_strings(['hey', 'aeo', 'mu', 'ooo', 'artro'], 1, 4))  # 3
print(vowel_strings(['vo', 'j', 'i', 's', 'i'], 0, 3))  # 1
print(vowel_strings(['m', 'qi', 'ae'], 1, 1))  # 0
