...
# (in the order specified by bills). Each customer will only buy one lemonade and pay with either a $5, $10, or $20
...
print(lemonade_change([5, 5, 10, 20, 5, 5, 5, 5, 5, 5, 5, 5, 5, 10, 5, 5, 20, 5, 20, 5]))  # True
print(lemonade_change([5, 5, 10, 10, 20]))  # False
print(lemonade_change([5, 5, 5, 5, 20, 20, 5, 5, 20, 5]))  # False
