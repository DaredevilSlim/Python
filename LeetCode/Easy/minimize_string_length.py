...
# Input: s = 'aaabc'
# Output: 3
# Explanation: In this example, s is 'aaabc'. We can start by selecting the character 'a' at index 1. We then remove the
# closest 'a' to the left of index 1, which is at index 0, and the closest 'a' to the right of index 1, which is at
...
# string becomes 'daaa'. In the new string, we can select the character 'a' at index 2. The closest occurrence of an 'a'
# to its left is at index 1, and the closest occurrence of an 'a' to its right is at index 3. We delete both of them,
...
print(minimized_string_length('aaabc'))  # 3
print(minimized_string_length('cbbd'))  # 3
print(minimized_string_length('dddaaa'))  # 2
print(minimized_string_length('ipi'))  # 2
