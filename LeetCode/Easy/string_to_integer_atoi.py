...
def my_atoi(s: str) -> int:
    if s == '+' or s == '-' or set(s) == {' '}:
        return 0
    if not s or s[0].isalpha() or s[0] == '.':
        return 0
    ...
    while i < len(s):
        if s[i] == '.':
            i = len(s)
        elif i < len(s) - 1 and s[i + 1].isdigit() and s[i].isalpha():
            return 0
        elif s[i] in '0123456789-+':
            a += s[i]
        i += 1
    if abs(int(a)) > 2147483647:
        return 2147483647 if int(a) > 0 else -2147483648
    return int(a)
...
print(my_atoi('.1'))  # 3
print(my_atoi('+-12'))  # 0
print(my_atoi('21474836460'))  # 0
print(my_atoi('91283472332'))  # 2147483647
print(my_atoi('-91283472332'))  # -2147483648
print(my_atoi('00000-42a1234'))  # 0
print(my_atoi('000000000000000000000000000011'))  # 11
print(my_atoi('      '))  # 0
print(my_atoi('  -0012a42'))  # -12
