...
# Input: n = 7
# Output: 21
# Explanation: Numbers in the range [1, 7] that are divisible by 3, 5, or 7 are 3, 5, 6, 7. The sum of these numbers is
# 21.
# Example 2:
# Input: n = 10
# Output: 40
...
print(sum_of_multiples(7))  # 21
print(sum_of_multiples(10))  # 40
print(sum_of_multiples(9))  # 30
