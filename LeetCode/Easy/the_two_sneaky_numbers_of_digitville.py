...
def get_sneaky_numbers(nums: list[int]) -> list[int]:
    return list(i for i in set(nums) if nums.count(i) > 1)


print(get_sneaky_numbers([0, 1, 1, 0]))  # [0, 1]
print(get_sneaky_numbers([0, 3, 2, 1, 3, 2]))  # [2, 3]
print(get_sneaky_numbers([7, 1, 5, 4, 3, 4, 6, 0, 9, 5, 8, 2]))  # [4, 5]
