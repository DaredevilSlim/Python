...
# Объект struct_time, возвращаемый функциями gmtime() и localtime(), содержит следующие атрибуты (указаны пары вида
...
# строкой формата. Если второй параметр не указан, будут выведены текущие дата и время. Если во втором параметре указан
...
# timedelta - дата в виде количества дней, секунд и микросекунд. Экземпляр этого класса можно складывать с экземплярами
