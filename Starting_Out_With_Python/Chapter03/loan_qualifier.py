...
if salary >= MIN_SALARY:
    if years_on_job >= MIN_YEARS:
        ...
        print(f'Вы должны отработать', f'не менее {MIN_YEARS}', f'лет, чтобы получить одобрение.')
else:
    print(f'Вы должны зарабатывать не менее $', f'{MIN_SALARY:,.2f}', f' в год, чтобы получить одобрение.')
