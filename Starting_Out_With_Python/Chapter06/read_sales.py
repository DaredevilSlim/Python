...
def main():
    ...
    # Прочитать первую строку из файла, но пока не конвертировать в число. Сначала нужно выполнить проверку на пустое
    # строковое значение.
    line = sales_file.readline()
    # Продолжать обработку до тех пор, пока из readline не будет возвращена пустая строка.
    while line != '':
