...
# Эта программа получает от пользователя данные о сотрудниках и сохраняет их в виде записей в файле employee.txt.
def main():
    ...
    for count in range(1, num_emps + 1):
        ...
        print(f'Введите данные о сотруднике No {count}')
        name = input('Имя: ')
