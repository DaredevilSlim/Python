...
# Эта программа получает серию оценок за лабораторные работы и вычисляет среднюю оценку, отбрасывая самую низкую.
def main():
    ...
    total -= lowest
    # Вычислить среднее значение. Обратите внимание, что мы делим на количество оценок минус 1, потому что самая низкая
    # оценка была отброшена.
    average = total / (len(scores) - 1)
    # Показать среднее значение.
    print(f'Средняя оценка с учетом отброшенной самой низкой оценки: {average}')


# Функция get_scores получает от пользователя серию оценок и сохраняет их в списке.
...
# Функция get_total принимает список в качестве аргумента и возвращает сумму значений в списке.
